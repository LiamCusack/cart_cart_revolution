...
class ShoppingCartTest < Minitest::Test
  ...
  def test_it_knows_total_products
    cart = ShoppingCart.new("King Soopers", "30items")
    product1 = Product.new(:paper, 'toilet paper', 3.70, '10')
    product2 = Product.new(:meat, 'chicken', 4.50, '2')
  ...
  def test_it_knows_percent_occupied
    cart = ShoppingCart.new("King Soopers", "30items")
    product1 = Product.new(:paper, 'toilet paper', 3.70, '10')
    product2 = Product.new(:meat, 'chicken', 4.50, '2')
    product3 = Product.new(:paper, 'tissue paper', 1.25, '1')
  ...
  def test_it_breaks_down_cart
    ...
    assert_equal @products_by_category = {:meat=>[product2], :paper=>[product1, product3], :produce=>[product4]}, cart.product_breakdown
  end
